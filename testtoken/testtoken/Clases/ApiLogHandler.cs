...
namespace testtoken.Clases
{
    public class ApiLogHandler : DelegatingHandler
    {
        ...
        private ApiLogEntry CreateApiLogEntryWithRequestData(HttpRequestMessage request)
        {
            try
            {
                // var context = ((HttpContextBase)request.Properties["MS_RequestContext"]);
                // var context = request.Properties["MS_RequestContext"];
                var context = request.Properties["MS_OwinContext"];
